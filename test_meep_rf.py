...
# ==========================================
# 6. シミュレーション実行と可視化（MPI並列・PVD一本化・XML対応版）
# ==========================================
...
def output_vti_step(sim):
    ...
    # 🚨【重要】データの取得は、デッドロックを防ぐため【全プロセス】で同時に呼び出します
    ...
    # 🚨【重要】ここから下は、ファイルの競合・破損を防ぐため【マスタープロセスのみ】が実行します
    if mp.am_master():
        # 1. 幾何形状やサイズの初期化（初回のみ）
        ...
        # 完全なXML形式 (VTI ASCII) でデータをクリーンに書き出し
